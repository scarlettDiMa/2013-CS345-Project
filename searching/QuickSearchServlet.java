...
public class QuickSearchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		"</div>"+
	"</div>");
            out.println("<h2 style='padding-left:35%'>Searching product....</h2><br><br>");
            ...
            try {
                ...
                /* Fetch Product details from database table*/
                stmt = con.createStatement();
                String st = request.getParameter("Product_Name");
                String search_st = "%" + st + "%";
                ...
                rs = stmt.executeQuery("SELECT * FROM product where item_name like '" + search_st + "'");
                ...
                while (rs.next()) {
                    ...
                    out.print("</td>");
                    out.print("<td style='width:180px;' >");
